  ...
  return (
    ...
    >
      ...
      <div className="container-custom relative z-10">
        <h1 className="text-3xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-100 to-pink-200 mb-2 font-heading opacity-0 animate-[fade-in_0.8s_ease-out_0.2s_forwards]">
          {title}
        </h1>
        {subtitle && (
          <p className="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto opacity-0 animate-[fade-in_0.8s_ease-out_0.4s_forwards]">
            {subtitle}
          </p>
        )}
      </div>
